...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<rspec-stubbed_env>.freeze, ["~> 1.0".freeze, ">= 1.0.2".freeze])
  s.add_development_dependency(%q<silent_stream>.freeze, ["~> 1.0".freeze, ">= 1.0.11".freeze])
